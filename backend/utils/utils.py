...
filtered_verses = [verse for verse in bible_data['verses'] if verse['book_name'] == 'Psalms' or verse['book_name'] == 'John' or verse['book_name'] == 'Romans' or  verse['book_name'] == 'Ephesians' or  verse['book_name'] == 'Philippians']
